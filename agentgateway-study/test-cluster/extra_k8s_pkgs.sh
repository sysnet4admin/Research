...
# override metallb ip range for aaif-benchmark cluster
# 이 클러스터는 192.168.2.0/24의 .100~.120 풀 배정 (루트 CLAUDE.md IP 배정표).
...
# NOTE(aaif-benchmark): agents-md 대비 제외한 것들과 이유
