...
echo "[011-evict] Creating logging namespace..."
kubectl --context "$CTX" create namespace logging --dry-run=client -o yaml \
  | kubectl --context "$CTX" apply -f -

echo "[011-evict] Deploying log-writer with tight ephemeral-storage limit..."
...
echo "[011-evict] Waiting 90s for eviction to occur..."
sleep 90

echo "[011-evict] Current state:"
